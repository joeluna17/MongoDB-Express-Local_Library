...
function createBookInstances(cb) {
    async.parallel([
        ...
        function(callback) {
          bookInstanceCreate(books[2], ' Gollancz, 2015.', false, 'Available', callback)
        },
        function(callback) {
        ...
        function(callback) {
          bookInstanceCreate(books[0], 'Imprint XXX2', false, 'Available', callback)
        },
        function(callback) {
          bookInstanceCreate(books[1], 'Imprint XXX3', false, 'Available', callback)
        }
        ],
        // Optional callback
        cb);
